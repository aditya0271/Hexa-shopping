...
<body>
    ...
    <div class="br-sideleft">
        ...
        <ul class="custom-scroll">
            ...
            <li class="active"><a href="elements.php" class="waves-effect waves-primary"><i class="la la-clone"></i>Elements</a></li>
        ...
        <div class="pagebody">
            ...
            <div class="card mb-5">
                <div class="card-header py-4">
                    <!-- <h5 class="text-secondary font-weight-bold mb-0">Product Id</h5> -->
                </div>
                <div class="card-body">
                    <ul class="d-flex align-items-center flex-wrap">
                        <li>
                        <div class="form-outline mb-2">
                   <h5> <label for="product_id" class="form-label">Product Id</label></h5>
                    <input type="text" name="product_id" id="product_id" class="form-control
                    35555
                    
                    2" placeholder="Enter product id">
                </div>
                        </li>
                    </ul>
                </div>
            ...
            <div class="card mb-5">
                <div class="card-header py-4">
                    <h5 class="text-secondary font-weight-bold mb-0">Brand Name</h5>
                </div>
                <div class="card-body">
                    <ul class="d-flex align-items-center flex-wrap">
                        <li>
            ...
            <div class="card mb-5">
                <div class="card-header py-4">
                    <h5 class="text-secondary font-weight-bold mb-0">Product Description</h5>
                </div>
                <div class="card-body">
                    <ul class="d-flex align-items-center flex-wrap">
            ...
            <div class="card mb-5">
                <div class="card-header py-4">
                    <h5 class="text-secondary font-weight-bold mb-0">Product Image</h5>
                </div>
                <div class="card-body">
                    <div class="row">
                        <!-- Primary Alert -->
